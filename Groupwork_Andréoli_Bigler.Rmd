...
Furthermore, we have found that a purely mathematical model like the ARIMA is clearly inferior to a GAM model with weather data as predictors. Since we considered both models in different modules it was very interesting for us to compare them.
