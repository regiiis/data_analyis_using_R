...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\SpecialCharTok{::}\NormalTok{opts\_chunk}\SpecialCharTok{$}\FunctionTok{set}\NormalTok{(}\AttributeTok{echo=}\ConstantTok{TRUE}\NormalTok{,}\AttributeTok{error=}\ConstantTok{FALSE}\NormalTok{,}\AttributeTok{warning=}\ConstantTok{FALSE}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# identify and set directory, then read data from csv}
...
\NormalTok{df\_plantA }\OtherTok{\textless{}{-}} \FunctionTok{read.csv}\NormalTok{(}\StringTok{"./data/A.csv"}\NormalTok{,}\AttributeTok{header=}\ConstantTok{TRUE}\NormalTok{,}\AttributeTok{sep =}\StringTok{","}\NormalTok{,}\AttributeTok{comment.char =}\StringTok{"\#"}\NormalTok{)}
\NormalTok{df\_plantB }\OtherTok{\textless{}{-}} \FunctionTok{read.csv}\NormalTok{(}\StringTok{"./data/B.csv"}\NormalTok{,}\AttributeTok{header=}\ConstantTok{TRUE}\NormalTok{,}\AttributeTok{sep =}\StringTok{","}\NormalTok{,}\AttributeTok{comment.char =}\StringTok{"\#"}\NormalTok{)}
\NormalTok{df\_plantC }\OtherTok{\textless{}{-}} \FunctionTok{read.csv}\NormalTok{(}\StringTok{"./data/C.csv"}\NormalTok{,}\AttributeTok{header=}\ConstantTok{TRUE}\NormalTok{,}\AttributeTok{sep =}\StringTok{","}\NormalTok{,}\AttributeTok{comment.char =}\StringTok{"\#"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
